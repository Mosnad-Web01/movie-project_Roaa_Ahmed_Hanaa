...
import FilterByGenreAndSort from '../../components/FilterByGenreAndSort'; // Use the existing FilterByGenreAndSort component
import DropdownMenu from '../../components/DropdownMenu'; // Use the existing DropdownMenu component
...
const TopRatedMovies = () => {
  ...
  const [moviesPerPage] = useState(6); // Number of movies per page
