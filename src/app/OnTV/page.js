...
import MovieCard from '../../components/MovieCard'; // استبدال DropdownMenu بمكون البطاقة
...
const OnTV = () => {
  ...
  const user = useAuth(); // التحقق من حالة تسجيل الدخول
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {currentShows.map(show => (
            <MovieCard 
              key={show.id} 
              item={show} 
              isLoggedIn={!!user} // تمرير حالة تسجيل الدخول
